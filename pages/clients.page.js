...
class ClientsPage extends AppPage{
    ...
    async deleteClient(email) {
        const options = $(`//tr[.//a[.="${email}"]]//span[contains(@class, "ant-dropdown-trigger ant-dropdown-link")]`);
        ...
        const buttonConfirm = $('//button[contains(@class, "ant-btn ant-btn-dangerous")][span[.="OK"]]');
